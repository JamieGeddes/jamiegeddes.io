...
description: How to use the Maybe type in Delphi to make method signatures honest and eliminate null dereference exceptions.
---
...
```pascal
function TWidgetRepository.GetById(id: Integer): Maybe<TWidget>;
var
  widget: TWidget;
begin
  for widget in widgets do
